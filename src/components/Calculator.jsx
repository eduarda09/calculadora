...
const Calculator = () => {
    ...
    const handleCalculate = () => {
        if(!pendingOperation || !setPendingValue){
            return;
        }
    ...
    return (
        <div className="calculator">
            ...
            <div className="buttons">
                <button onClick={() => handleClear()} style={{background: '#ff4d4d'}} >AC</button>
                ...
                <button onClick={handleCalculate} style={{background: '#F4C430'}}>=</button>
            </div>
